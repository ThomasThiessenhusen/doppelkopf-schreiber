export const de = {
  ...
  addGame: {
    loading: 'Laedt …',
    errorPrefix: 'Fehler',
    bockBannerSingle: 'Dieses Spiel ist Bock — Sieger erhaelt +2 zusaetzlich',
    bockBannerDouble: 'Dieses Spiel ist Doppelbock — Sieger erhaelt +4 zusaetzlich',
    ...
    manualBockTitle: 'Pflichtbock ausloesen',
    manualBockHint: 'Loest eine neue Bockrunde ab dem naechsten Spiel aus.',
  ...
  sheet: {
    ...
    deleteGameTitle: 'Spiel loeschen?',
  },
} as const;
